  ...
  return (
    <div className={`min-h-screen flex items-center justify-center ${variant?.background ?? 'bg-gradient-to-br from-rose-100 via-pink-50 to-rose-200 dark:from-slate-950 dark:via-gray-900 dark:to-slate-950'} px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative overflow-hidden transition-colors duration-500`}>
      ...
      <div className="max-w-3xl w-full relative z-10">
        {/* Liquid glass card */}
        <div className={`${variant?.cardBg ?? 'bg-white/40 dark:bg-white/[0.07] backdrop-blur-xl'} rounded-3xl shadow-2xl ${variant?.shadowColor ?? 'shadow-rose-200/50 dark:shadow-black/30'} p-6 sm:p-10 lg:p-12 border border-white/60 dark:border-white/[0.12] relative overflow-hidden min-h-[500px] sm:min-h-[550px] lg:min-h-[600px] flex flex-col justify-center transition-colors duration-500`}>
